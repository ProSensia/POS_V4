...
<head>
    ...
    <title><?php $Controller->app(); ?>:: Admin Account Setup </title>
...
<!-- A Product of KodeMadeEazy| FlatERP Teach -->
                        <div class="col-lg-6 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h100">
                            <div class="w-100 p-3 p-md-5 card border-0 shadow-sm" style="max-width: 32rem;">
                                <!-- Form -->
                                <form class="row g-1 p-3 p-md-4" id="newAdminForm" autocomplete="off">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control form-control-lg" placeholder="John Doe" name="fullname">
                                        </div>
                                    </div>
                                      <input type="hidden" name="action" value="create_admin_account_">
                                    <div class="col-12">
                                        <div class="mb-2">
                                            <label class="form-label">e-mail</label>
                                            <input type="text" class="form-control form-control-lg" placeholder="admin@mail.com" name="email">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-2">
                                    ...
                                    <div class="col-12 col-md-12 text-center mt-2">
                                      <button type="submit" class="btn btn-lg btn-block btn-dark lift loginLoading" style="width: 100% !important;">SUBMIT</button>
                                    </div>
    ...
    $("#newAdminForm").on("submit",function(e){
       ...
       $.post("app/View",formData,function(data){
           setTimeout(function(){
               $(".loginLoading").html("SUBMIT").attr("disabled", false);
