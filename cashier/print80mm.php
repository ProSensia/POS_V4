    ...
    <table class="text-center" width="auto" border="0"
      ...
      <tr>
        <td colspan="3" align="center">
          ...
          <span style='font-size:30px;line-height:2px'><strong><?php echo strtoupper($warehouse_data->store_name);?></span></strong><br/>
          <div style='font-size:16px; font-weight:700; margin-top:0px'>
            <br><?php echo ucwords($warehouse_data->store_location);?>
            <br> Tel: <?php echo $warehouse_data->phone;?></div>
          <br />
        </td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <tr>
        ...
        <td style="border-bottom:thick#000000 double"><span
            class="style1"><?php $Controller->currency();?><?php echo number_format($order_data->total, 2); ?></span></td>
      </tr>
       <tr>
        <td colspan="2">DISCOUNT:</td>
        <td><span style="border-bottom:thin #000000"><?php $Controller->currency();?><?php echo number_format($order_data->discount_percent,2);?></span></td>
      </tr> 
       <tr>
        <td colspan="2">PAYABLE</td>
        <td><span style="border-bottom:thin #000000"><?php $Controller->currency();?><?php echo number_format($order_data->discount_price,2);?></span></td>
      </tr>
      <tr>
        <td colspan="2">PAID:</td>
        <td><span style="border-bottom:thin #000000"><?php $Controller->currency();?><?php echo number_format($order_data->paid,2);?></span></td>
      </tr>
       <tr>
        <td colspan="2">BALANCE:</td>
        <td><span style="border-bottom:thin #000000"><?php $Controller->currency();?><?php echo number_format($order_data->due,2);?></span></td>
      </tr>
       <tr>
