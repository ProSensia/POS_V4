                     ...
                     <div class="row g-1 g-sm-3 mb-3 row-deck">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                           <div class="card">
                              <div class="card-body py-xl-4 py-3 d-flex flex-wrap align-items-center justify-content-between">
                                 <div class="left-info">
                                    <span class="text-muted">All Invoices</span>
                              ...
                              <div class="card-body py-xl-4 py-3 d-flex flex-wrap align-items-center justify-content-between">
                                 <div class="left-info">
                                    ...
                                    <div><span class="fs-6 fw-bold me-2"><?php echo
                                       $Controller->getcountProductsByStoreId($storeId);?></span></div>
                                 </div>
                                 <div class="right-icon">
                           ...
                           <div class="card">
                              <div class="card-body py-xl-4 py-3 d-flex flex-wrap align-items-center justify-content-between">
                                 <div class="left-info">
                                    ...
                                    <div><span class="fs-6 fw-bold me-2"><?php $Controller->currency();?><?php echo
                  ...
                  <div class="col-md-12">
                     <div class="card">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center bg-transparent border-bottom-0">
                           <h4 class="m-0 fw-bold text-primary">Today's <strong class="text-danger"> <?php echo date("l jS F, Y") ?></strong> Sales Transactions </h4>
                        </div>
                        <div class="card-body">
                           <table id="myDataTable" class="table table-hover align-middle mb-0" style="width: 100%;">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td><?php $Controller->currency();?><?php echo number_format($order->discount_price);?></td>
