            ...
            <div class="container-xxl">
                     ...
                     <div class="alert-success alert mb-0">
                        <div class="d-flex align-items-center">
                           ...
                           <div class="flex-fill ms-3 text-truncate">
                              ...
                              <span class="small"><?php $Controller->currency();?><?php echo number_format($Controller->getmonthlySalesRecordByPaymentTypeByCashier("Cash",$userData->username),2) ?></span>
                     ...
                     <div class="alert-danger alert mb-0">
                        <div class="d-flex align-items-center">
                           ...
                           <div class="flex-fill ms-3 text-truncate">
                              ...
                              <span class="small"><?php $Controller->currency();?><?php echo number_format($Controller->getmonthlySalesRecordByPaymentTypeByCashier("Transfer",$userData->username),2) ?></span>
                     ...
                     <div class="alert-warning alert mb-0">
                        <div class="d-flex align-items-center">
                           ...
                           <div class="flex-fill ms-3 text-truncate">
                              ...
                              <span class="small"><?php $Controller->currency();?><?php echo number_format($Controller->getmonthlySalesRecordByPaymentTypeByCashier("POS",$userData->username),2) ?></span>
                     ...
                     <div class="alert-info alert mb-0">
                        <div class="d-flex align-items-center">
                           ...
                           <div class="flex-fill ms-3 text-truncate">
                              ...
                              <span class="small"><?php $Controller->currency();?><?php echo number_format($Controller->getmonthlySalesRecordByPaymentTypeByCashier("Cheque",$userData->username),2) ?></span>
               ...
               <div class="row g-3 mb-3">
                  <div class="col-md-12">
                     <div class="card">
                        <div class="card-body">
                          <h3 class="text-muted mt-2 mb-2">You can search sales record by date</h3>
                           <div class="mb-3">
                              <form action="" class="row gy-2 gx-3 align-items-center" method="post">
                                 ...
                                 <div class="col-md-2">
                                    <button type="submit" class="btn btn-dark btn-md" name="search_sales_btn" value="get_report_by_date"><span class="icofont-search fs-5"></span> Search Record</button>
                                 </div>
                              </form>
                           </div>
                        </div>
                  ...
                  <?php if (isset($_POST['search_sales_btn']) && $_POST['search_sales_btn'] === "get_report_by_date"): ?>
                     ...
                     if ($Controller->isEmptyStr($date_from) || $Controller->isEmptyStr($date_to)) {
                      ...
                      $filterReports = $Controller->fetchSalesOrderReportsByDateByCashier($date_from,$date_to,$payment_type,$userData->username);
                     ...
                     <div class="card">
                        <div class="card-body">
                           <table id="myDataTable" class="table table-hover align-middle mb-0" style="width: 100%;">
                              ...
                              <tbody>
                                 <?php 
                                    $AllOrders = $Controller->fetchAllSalessTransactionsByCashier($userData->username);
                                    if ($AllOrders !="") {
