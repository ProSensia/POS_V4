                                    ...
                                    <div class="card-body">
                                       ...
                                       <div class="row mb-4">
                                          <div class="col-sm-6">
                                             ...
                                             <div>Office Add:<?php echo APP_AUTHOR_ADDRESS;?></div>
                                          ...
                                          <table class="table table-striped">
                                             ...
                                             <tbody>
                                                ...
                                                if ($orderLists) {
                                                   ...
                                                   <td class="text-end"><?php $Controller->currency();?><?php echo number_format($item->price,2);?></td>
                                                   <td class="text-center"><?php echo $item->qty;?></td>
                                                   <td class="text-end"><?php $Controller->currency();?><?php echo number_format($item->subtotal,2);?></td>
                                                </tr>
                                             ...
                                             <table class="table table-clear">
                                                <tbody>
                                                   <tr>
                                                      ...
                                                      <td class="text-end"><?php $Controller->currency();?><?php echo number_format($order_data->total,2); ?></td>
                                                   </tr>
                                                   <tr>
                                                      <td ><strong>Paid:</strong></td>
                                                      <td class="text-end"><?php $Controller->currency();?><?php echo number_format($order_data->paid,2); ?></td>
                                                   </tr>
                                                   <tr>
                                                      <td ><strong>Due:</strong></td>
                                                      <td class="text-end"><strong><?php $Controller->currency();?><?php echo number_format($order_data->due,2); ?></strong></td>
                                                   </tr>
                                                </tbody>
                                             </table>
                                          </div>
