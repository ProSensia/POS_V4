                           ...
                           <div class="row mt-2">
                              <div class="col-md-6 mb-3">
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="customer_name" class="form-control form-control-lg" id="guest_name" placeholder="Optional [Required for credit sales]">
                                 </div>
                              </div>
                              <div class="col-md-6 mb-3">
                                 <div class="form-group">
                                    <label>Phone:</label>
                                    <input type="tel" name="customer_phone" class="form-control form-control-lg" placeholder="Optional [Required for credit sales]">
                                 </div>
                              </div>
                              <div class="col-md-6 mb-3">
                                 <div class="form-group">
                                    <label>Email:</label>
                                    <input type="email" name="customer_email" class="form-control form-control-lg" placeholder="Optional [Required for credit sales]">
                                 </div>
                              </div>
                              <div class="col-md-6 mb-3">
                                 <div class="form-group">
                                    <label>Select Product &raquo; Category</label>
                                    <select class="form-control form-select-lg form-control-lg selectProduct select2" id="selectProduct" name="prod_id" style="min-width:200px">
                                       <option value="" selected>Select...</option>
                                       <?php echo $Controller->showProductsInDropDownListByStoreId($storeId);?>
                                    </select>
                                 </div>
                              </div>
                                       ...
                                       <tbody>
                                          <tr>
                                           ...
                                           <tr>
                                             ...
                                             <td></td>
                                             <td></td>
                                             <td class="text-right"><button type="button" class="btn btn-primary" onclick="superSalePrice();">Apply Discount</button> </td>
                                             <td style="text-align: right; padding-right: 30px;width: 260px"><input type="number" name="discount" id="discount" placeholder="discount e.g 1000" class="form-control">
                                               </td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                             ...
                                             <td style="text-align: right; padding-right: 30px;width: 230px">
                                                <input class="form-control form-control-lg text-right tenderAmount" type="text" id="tenderAmount" placeholder="Enter amount paid" name="tenderAmount">
                                             </td>
                                          </tr>
