                        ...
                        <div class="border-0 mb-4">
                            <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                                ...
                                <div class="col-auto d-flex w-sm-100">
                                    <button type="button" onclick="window.location.assign('./');" class="btn btn-primary btn-set-task w-sm-100"><i class="icofont-home me-2 fs-6"></i></button>
                                </div>
                            </div>
                        </div>
                    </div> <!-- Row end  -->
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <table class="table table-hover align-middle mb-0" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                             $allProfitLoss = $Controller->getAllProfit();
                                             if ($allProfitLoss) {
                                                $cnt=0;
                                                 foreach ($allProfitLoss as $pl) {
                                                    $exp =  $Controller->getExpenditureByStoreId($pl->wareId);
                                                     $warehouse =  $Controller->get_store_by_id($pl->wareId);
                                                    $cnt++;
                                                    ?>
                                                     <tr>
                                               <td><?php echo $cnt;?></td>
                                               ...
                                               <td><?php $Controller->currency()?><?php echo number_format(($pl->gross_profit -$exp->amt),2);?></td>
