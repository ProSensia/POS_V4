                           ...
                           <table id="myDataTable" class="table table-striped mb-0" style="width: 100%;">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td>Name : <span><strong><?php echo htmlspecialchars_decode($product->name); ?></strong></span><br>
                                        Price : <span class="text-info"><strong><?php $Controller->currency();?><?php echo number_format($product->selling_price,2) ?></strong></span> <br>
                                       Qty : <span class="text-info"><strong><?php echo $product->qty; ?></strong></span>
                                    </td>
                                    ...
                                    <td>
                                       <div class="btn-group" role="group" aria-label="Basic outlined example">
                                          ...
                                          <button type="button" title="Click to remove" data-action="delete_product" data-id="<?php echo $product->proId;?>" class="btn btn-outline-secondary deleterow"><i class="icofont-ui-delete text-danger"></i></button>
                                       </div>
                                    </td>
                                 </tr>
                                 <?php
                     ...
                     <form id="AddProductForm" autocomplete="off">
                        <div class="row g-3 mb-2">
                           <div class="col-sm-6">
                              ...
                              <input type="text" class="form-control form-control-lg" id="item" placeholder="Item Name..." name="item">
                           </div>
                           <div class="col-sm-6">
                              <label for="item_desc" class="form-label">Product Description</label>
                              <input type="text" class="form-control form-control-lg" id="item_desc" placeholder="Item Description..." name="item_desc">
                           </div>
                        </div>
                        <div class="row g-3 mb-2">
                           <div class="col-sm-4 col-md-4">
                              <label for="cost" class="form-label">Cost Price</label>
                              <input type="text" class="form-control form-control-lg" id="cost" placeholder="e.g <?php $Controller->currency();?>2,000.00" name="cost">
                           </div>
                           <div class="col-sm-4 col-md-4">
                              <label for="item_price" class="form-label">Selling Price</label>
                              <input type="text" class="form-control form-control-lg" id="item_price" placeholder="e.g <?php $Controller->currency();?>2,500.00" name="item_price">
                           </div>
                           <div class="col-sm-4 col-md-4">
                              <label for="item_qty" class="form-label">Qty (Cartons)</label>
                              <input type="number" class="form-control form-control-lg" name="item_qty" placeholder="e.g 100 qty">
                           </div>
                        </div>
                        <div class="row g-3 mb-3">
                           <!-- <div class="col-md-4">
                     ...
                     <form id="ImportCSVFileModalForm" enctype="multipart/form-data">
                        <div class="row g-3 mb-3">
                            <div class="col-sm-12">
                              ...
                              <input type="file" class="form-control form-control-lg" name="file_import" id="file_import" required>
                           </div>
