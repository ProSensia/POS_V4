                    ...
                    <div class="row align-items-center">
                        <div class="border-0 mb-4">
                            <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                                <h3 class="fw-bold mb-0 text-danger">Expiration Notification</h3>
                            </div>
                        </div>
                    </div> <!-- Row end  -->
                            ...
                            <div class="alert-danger alert mb-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-fill ms-3 text-truncate">
                                        ...
                                        <span class="small"><?php echo $Controller->CountExpired();?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="alert-danger alert mb-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-fill ms-3 text-truncate">
                                        ...
                                        <span class="small"><?php echo $Controller->countExpiredInSevenDaysTime();?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="alert-warning alert mb-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-fill ms-3 text-truncate">
                                        ...
                                        <span class="small"><?php echo $Controller->countExpiredInThreeMonthTime();?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="alert-warning alert mb-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-fill ms-3 text-truncate">
                                        ...
                                        <span class="small"><?php echo $Controller->countExpiredInSixMonthTime();?></span>
                                    </div>
                                </div>
                            </div>
                        </div> 
