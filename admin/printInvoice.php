                                    ...
                                    <div class="card-body">
                                       ...
                                       <div class="row mb-4">
                                          <div class="col-sm-6">
                                             ...
                                             <div><strong><?php echo strtoupper($cProfile->company);?></strong></div>
                                              <div>Office Add:<?php echo ucwords($cProfile->address);?></div>
                                             <div>Email: <b><?php echo ($cProfile->email);?></b> </div>
                                             <div>Phone: <b><?php echo ($cProfile->phone);?></b> </div>
                                          </div>
                                          <div class="col-sm-6">
                                             <h6 class="mb-3">To:</h6>
                                             <div><strong><?php echo $order_data->customer; ?></strong></div>
                                             <div>Email: <?php echo $order_data->email; ?></div>
                                             <div>Phone: <?php echo $order_data->phone; ?></div>
                                          </div>
                                       </div>
                                       <!-- Row end  -->
                                       ...
                                       <div class="row">
                                          <div class="col-lg-12">
                                             ...
                                             <p class="text-muted">Your term and condition goes here</p>
                                          </div>
                                          <div class="col-lg-12 text-end">
                                             <!--  -->
                                             <a href="print80mm?invid=<?php echo $order_data->orderId;?>&action=generate"> <button type="button" class="btn btn-secondary btn-lg my-1"><i class="fa fa-print"></i> Print</button></a>
