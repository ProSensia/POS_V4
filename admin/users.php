   ...
   <head>
                                 ...
                                 <?php 
                                    ...
                                    if ($AllUsers !="") {
                                        ...
                                        foreach ($AllUsers as $user) {
                                          $store_data = $Controller->get_store_by_id($user->store_id);
                                            $cnt++;?>
                                 <tr>
                                    ...
                                    <td><?php if ($store_data) {
                                      echo $store_data->store_name;
                                    }else{
                                    ...
                                    <td>
                                        ...
                                        if ($userData->userType === "Administrator") {
                                          if ($user->userType == "Administrator") {
                                             echo '<a href="./edit-user?id='.$user->id.'&action=edit"><button class="btn btn-primary" type="button" >Edit</button></a>';
                                          }else{
                                              echo '<button type="button" title="Functionality coming soon" class="btn btn-danger del_btn text-white" data-action="delete_user" data-id="'.$user->id.'">Delete</button> <a href="./edit-user?id='.$user->id.'&action=edit"><button class="btn btn-primary" type="button" >Edit</button></a>';
                                          }
               ...
               <div class="modal-content">
                ...
                Show password</label>
                           ...
                           <div class="row g-3 mb-3">
                              ...
                              <div class="col-md-6">
                              <label for="store_id" class="form-label">Warehouse</label>
      ...
      <script>
         ...
         $(".del_btn").on("click", function(e){
            e.preventDefault();
            let userId = $(this).data("id"),action = $(this).data("action");
            if (confirm("Do you really want to delete the selected User?"))
             {
               ...
               $.post("../app/View",data,function(response){
            setTimeout(function(){
