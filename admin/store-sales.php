...
<html class="no-js" lang="en" dir="ltr">
   <head>
      ...
      <title>::POS:: Store sales report </title>
      <!--    GENERAL SCRIPT-->
               ...
               <div class="row align-items-center">
                  <div class="border-0 mb-4">
                     <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                        <h3 class="fw-bold mb-0">Store sales report</h3>
                     </div>
                  </div>
               </div>
               <!-- Row end  -->
                     ...
                     <div class="card">
                        <div class="card-body">
                           <table id="myDataTable" class="table table-hover align-middle mb-0" style="width: 100%;">
                              ...
                              <tbody>
                                 <?php 
                                    $salesRec = $Controller->getProductSalesRecords($pid);
                                    if ($salesRec !="") {
                                       $cnt=0;
                                        foreach ($salesRec as $sales) {
                                        $cnt++; 
                                          ?>
                                 <tr>
                                    <td><?php echo $cnt;?></td>
                                    <td><span><?php echo htmlspecialchars_decode($sales->product); ?></span></td>
                                   
                                   <td><?php echo ($sales->qty) ?></td>
                                    <td>&#8358;<?php echo number_format($sales->price,2) ?></td>
                                    <td>
                                       <?php echo ($sales->subtotal);?>
                                    </td>
                                    <td><?php echo date("Y-m-d",strtotime($sales->trans_date)) ?></td>
                                    <td>
                                       <a href="printInvoice?invid=<?php echo $sales->invoice_id?>&action=generate">View Report</a>
                                    </td>
