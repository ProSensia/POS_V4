                           ...
                           <div class="card">
                              <div class="card-body py-xl-4 py-3 d-flex flex-wrap align-items-center justify-content-between">
                                 <div class="left-info">
                                    ...
                                    <div><span class="fs-6 fw-bold me-2"><?php $Controller->currency();?><?php echo number_format($Controller->CurrentMonthSalesrecord(),2);?></span></div>
                                 </div>
                                 <div class="right-icon">
                           ...
                           <div class="card">
                              <div class="card-body py-xl-4 py-3 d-flex flex-wrap align-items-center justify-content-between">
                                 <div class="left-info">
                                    ...
                                    <div><span class="fs-6 fw-bold me-2"><?php $Controller->currency();?><?php echo number_format($Controller->lastThreeMonthSalesrecord(),2);?></span></div>
                                 </div>
                                 <div class="right-icon">
                           ...
                           <div class="card">
                              <div class="card-body py-xl-4 py-3 d-flex flex-wrap align-items-center justify-content-between">
                                 <div class="left-info">
                                    ...
                                    <div><span class="fs-6 fw-bold me-2"><?php $Controller->currency();?><?php echo number_format($Controller->lastSixMonthSalesrecord(),2);?></span></div>
                                 </div>
                                 <div class="right-icon">
                           ...
                           <div class="card">
                              <div class="card-body py-xl-4 py-3 d-flex flex-wrap align-items-center justify-content-between">
                                 <div class="left-info">
                                    ...
                                    <div><span class="fs-6 fw-bold me-2"><?php $Controller->currency();?><?php echo number_format($Controller->currentYearRevenue(),2) ?></span></div>
                                 </div>
                                 <div class="right-icon">
