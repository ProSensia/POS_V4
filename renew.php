                            ...
                            <div class="w-100 p-3 p-md-5 card border-0 shadow-sm" style="max-width: 32rem;">
                                ...
                                <form class="row g-1 p-3 p-md-4" id="productActivationForm" autocomplete="off">
                                    <div class="col-12 text-center mb-2">
                                        <h1>Product Renewer Page</h1>
                                        
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-2">
                                            <label class="form-label">Your Registration Name</label>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-2">
                                            <label class="form-label">Renewer Code</label>
                                            <input type="text" class="form-control form-control-lg" placeholder="enter renewer code" name="code">
                                        </div>
                                    </div>
                                   
                                    <div class="col-12 col-md-12 text-center mt-2">
                                      <button type="submit" class="btn btn-lg btn-block btn-dark lift loginLoading" style="width: 100% !important;">RENEW NOW</button>
                                    </div>
